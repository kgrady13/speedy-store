...
const products = [
  {
    ...
    price: "$90.00",
    quantity: 1,
    imageSrc: "/assets/images/dress-1.webp",
    imageAlt:
  ...
  },
  {
    ...
    price: "$32.00",
    quantity: 1,
    imageSrc: "/assets/images/shoes-1.webp",
    imageAlt:
...
export default function Cart() {
  return (
    <Sheet>
      <SheetTrigger
        aria-label="Cart"
        className="transition-colors duration-200 p-4 border-l hover:bg-brand-green hover:text-brand-beige border-brand-green/20"
      >
        <svg
      ...
      <SheetContent className="bg-brand-beige/90 backdrop-blur w-full overflow-y-auto">
        <SheetHeader>
          ...
          <>
            ...
            <div className="border-t border-gray-200 py-8">
              <div className="flex justify-between text-base font-medium text-gray-900">
                <p>Subtotal</p>
                <p className="font-sans">$262.00</p>
              </div>
